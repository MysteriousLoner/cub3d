...
void	init_horizontal(t_raycasting_vars *ray_vars,
			t_cub3d *vars, t_player *player);
void	check_horizontal(t_raycasting_vars *ray_vars,
			t_cub3d *vars, t_player *player);
void	init_vertical(t_raycasting_vars *ray_vars,
			t_cub3d *vars, t_player *player);
void	check_vertical(t_raycasting_vars *ray_vars,
			t_cub3d *vars, t_player *player);
void	init_rays(t_cub3d *vars, t_player *player,
			t_raycasting_vars *ray_vars);
void	calculate_and_render_wall(t_cub3d *vars,
			t_player *player, t_raycasting_vars *ray_vars);
...
int		compute_colour(t_cub3d *vars, int y,
			float dist, t_raycasting_vars *ray_vars);
void	drawwalls(t_cub3d *vars, int r,
			float dist, t_raycasting_vars *ray_vars);
